                ...
                <li className="d-flex justify-content-start">
                  <div className="card rounded-4 max-width-60 mx-3 my-2 bg-light-gray">
                    <div className="card-body">
                      ...
                      consequatur recusandae tempore fugit incidunt reiciendis tenetur.
                      Sit, ipsum omnis consequatur molestiae amet, molestias error quos
                      rem, accusamus nemo recusandae? Corrupti!
                    </div>
                  </div>
                </li>
